...
add_shortcode('card', 'yosa_card');

// Register custom script

function add_custom_script(){
	wp_enqueue_script('theme-js', get_stylesheet_directory_uri() . './assets/js/theme.js', array('wp-embed', 'jquery'), time(), true);
}
add_action('wp_print_scripts', 'add_custom_script');


// Register stylesheet script

function add_custom_style(){
	wp_enqueue_style('theme-css', get_stylesheet_directory_uri() . './assets/css/custom.css', array(), time());
}
add_action('wp_print_scripts', 'add_custom_style');
